...
namespace UI.WinForms.UnitTests
{
    ...
    public class CommonControlHelperTests
    {
        ...
        public void Setup()
        {
            ...
            Assembly assembly = typeof(Ui).Assembly;
            Resources.ExecutingAssembly = typeof(Ui).Assembly;
        }

        [Test]
        public void CommonControlHelpers_ToolBar_CreateButton_CreatesToolstripButton_PrefixedName()
        {
            ToolStripButton btn = Ui.ToolBar.CreateButton("Edit Button", Constants.ImageKeys.EditSnippet, 
        ...
        {
            ToolStripButton btn = Ui.ToolBar.CreateButton("Edit", Constants.ImageKeys.EditSnippet,
                new System.EventHandler((s, e) => { }));
