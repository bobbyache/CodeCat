    ...
    public static class TopicSectionControlFactory
    {
        public static ITopicSectionBaseControl Create(ITopicSection topicSection, IImageResources imageResources, IFile workItem, IAppFacade application, EventHandler modifiedEventHandler)
        {
            ...
            if (topicSection is ICodeTopicSection)
            {
                ...
                topicSectionControl = new CodeTemplateTopicSectionControl(application, imageResources, workItem as ITopicDocument, topicSection as ICodeTemplateTopicSection);

            else if (topicSection is ISearchableEventTopicSection)
                topicSectionControl = new SearchableEventTopicSectionControl(application, imageResources, workItem as ITopicDocument, topicSection as ISearchableEventTopicSection);
                ...
                topicSectionControl = new FileAttachmentsTopicSectionControl(application, imageResources, workItem as ITopicDocument, topicSection as IFileAttachmentsTopicSection);

            else if (topicSection is IPdfViewerTopicSection)
                topicSectionControl = new PdfDocumentControl(application, imageResources, workItem as ITopicDocument, topicSection as IPdfViewerTopicSection);

            else if (topicSection is ISingleImageTopicSection)
                topicSectionControl = new ImageControl(application, imageResources, workItem as ITopicDocument, topicSection as ISingleImageTopicSection);
            ...
            //topicSectionControl = new SingleImageTopicSectionControl(application, topicDocument as ITopicDocument, topicSection as ISingleImageTopicSection);
                ...
                topicSectionControl = new ImageSetControl(application, imageResources, workItem as ITopicDocument, topicSection as IImagePagerTopicSection);

            else if (topicSection is IRichTextEditorTopicSection)
                topicSectionControl = new RichTextBoxTopicSectionControl(application, imageResources, workItem as ITopicDocument, topicSection as IRichTextEditorTopicSection);

            else if (topicSection is ITasksTopicSection)
                topicSectionControl = new TaskListTopicSectionControl(application, imageResources, workItem as ITopicDocument, topicSection as ITasksTopicSection);
